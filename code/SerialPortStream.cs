...
namespace RJCP.IO.Ports
{
    ...
    public partial class SerialPortStream : Stream
    {
        ...
        /// <summary>
        /// Constructor. Create a stream that connects to the specified port and sets the initial baudrate
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <param name="port">The name of the COM port, such as "COM1" or "COM33"</param>
        /// <param name="baud">The baudrate that is passed to the underlying driver</param>
        ...
        /// supports the databits provided. The special type 16X is not supported</param>
        ...
        /// it is arbitrarly picked to be 64KB) and the local driver also has buffered
